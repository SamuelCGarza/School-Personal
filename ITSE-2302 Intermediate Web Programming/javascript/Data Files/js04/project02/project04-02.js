...
let quotes = [
    ...
    function quoteGenerator() {
        ...
        let randomQuote = randomInt(0, quoteCount - 1); // Fixed incorrect high range to avoid using a value out of range of quotes array 
       
        // Retrieve a randomly-selected quote
        let quote = quotes[randomQuote];
       
        // Display the random quote
        document.getElementsByTagName("blockquote")[0].innerHTML = quote; // Fixed use of incorrect index value of blockquote tags and syntax error 
    }
